...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex items-center justify-center px-4 py-8 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute top-0 right-0 -mt-40 -mr-40 w-80 h-80 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
      <div className="absolute bottom-0 left-0 -mb-40 -ml-40 w-80 h-80 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/2 left-1/2 -mt-40 -ml-40 w-80 h-80 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 backdrop-blur-md bg-opacity-95">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">Sign in to your account to continue your career journey</p>
          </div>
